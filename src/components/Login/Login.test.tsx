...
describe('Login Component', () => {
  ...
  test('submits the form and redirects on successful login', async () => {
    ...
    global.fetch = jest.fn().mockResolvedValueOnce({
      ok: true,
      json: async () => await Promise.resolve({ message: 'Authentication successful', redirectUrl: '/dashboard' })
    })
  ...
  test('displays error message on unsuccessful login', async () => {
    ...
    global.fetch = jest.fn().mockResolvedValueOnce({
      ok: false,
      json: async () => await Promise.resolve({ message: 'Authentication failed' })
    })
